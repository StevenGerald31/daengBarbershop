...
router.get("/tambahLokasi", adminController.tambah_lokasi);
router.get("/editLokasi", adminController.edit_lokasi);
router.get("/deleteLokasi", adminController.delete_lokasi);
